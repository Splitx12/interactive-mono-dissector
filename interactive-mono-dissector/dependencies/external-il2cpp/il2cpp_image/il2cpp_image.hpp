...
namespace il2cpp::types
{
	...
	public:
		...
		std::optional<std::reference_wrapper<const std::pair<std::string, il2cpp_class_t>>> get_class(const std::string& class_name) const;

		il2cpp_image_t(il2cpp_image_t&&) = default;

		explicit il2cpp_image_t() = default;
