...
std::optional<std::reference_wrapper<const std::pair<std::string, il2cpp::types::il2cpp_class_t>>> il2cpp::types::il2cpp_image_t::get_class(const std::string& class_name) const
{
    const auto classes_iterator = std::ranges::find(classes, class_name, &std::pair<std::string, il2cpp_class_t>::first);

    return classes_iterator == classes.cend() ? std::nullopt : std::make_optional(std::ref(*classes_iterator));
}
...
il2cpp::types::il2cpp_image_t::il2cpp_image_t(const std::uintptr_t instance, const il2cpp_t& il2cpp) : instance{ instance }
{
    ...
    for (auto i = 0u; i < classes_size; ++i)
    {
        ...
        classes.emplace_back(il2cpp.read_string(il2cpp.read<std::uintptr_t>(current_class + 0x10)).c_str(), il2cpp_class_t{ current_class, il2cpp });
    }
}